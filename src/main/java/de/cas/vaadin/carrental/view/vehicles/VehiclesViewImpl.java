...
public class VehiclesViewImpl extends CustomComponent implements VehiclesView{	
	...
	public VehiclesViewImpl() {
		...
		CASCarRentalApplication.getMainUI().addWindow(dialog);
		...
		dialogContentFormLayout.addComponents(manufacturerField, typeField, dailyPriceField, vehicleStateComboBox, numberPlateField, modalButtons);
